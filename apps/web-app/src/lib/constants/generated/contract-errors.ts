 ...
 *   - apps/contracts/stellar-contracts/rwa-oracle/src/error.rs
 *   - apps/contracts/stellar-contracts/rwa-token/src/error.rs
...
export const CONTRACT_ERRORS: Record<number, ContractErrorInfo> = {
  ...
  9: {
    ...
    message: "Asset requires approval before transfer",
    contract: "rwa-token",
  },
  10: {
    code: "ApprovalPending",
    message: "Asset approval is pending",
    contract: "rwa-token",
  },
  11: {
    code: "ApprovalRejected",
    message: "Asset approval was rejected",
    contract: "rwa-token",
  },
  12: {
