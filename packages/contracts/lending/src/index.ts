// @ts-nocheck
// This file is auto-generated by Stellar CLI - do not edit manually
...
export const networks = {
  testnet: {
    ...
    contractId: "CD5WNBT4NEYYLALY776KRRR2WP7BEM4VJPG6QYQE5CRO6C5H4YUQA5KS",
  }
} as const
...
export type AuctionStatus = {tag: "Active", values: void} | {tag: "Filled", values: void} | {tag: "Cancelled", values: void};
...
export interface Client {
   ...
   */
  initialize: ({admin, rwa_oracle, reflector_oracle, backstop_threshold, backstop_take_rate}: {admin: string, rwa_oracle: string, reflector_oracle: string, backstop_threshold: i128, backstop_take_rate: u32}, options?: {
    /**
   ...
   */
  set_collateral_factor: ({rwa_token, factor}: {rwa_token: string, factor: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_interest_rate_params: ({asset, params}: {asset: string, params: InterestRateParams}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * Set pool state
   */
  set_pool_state: ({state}: {state: PoolState}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_backstop_threshold: ({threshold}: {threshold: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_backstop_take_rate: ({take_rate}: {take_rate: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_token_contract: ({asset, token_address}: {asset: string, token_address: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_backstop_token: ({token_address}: {token_address: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  deposit: ({lender, asset, amount}: {lender: string, asset: string, amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  withdraw: ({lender, asset, b_tokens}: {lender: string, asset: string, b_tokens: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_b_token_balance: ({lender, asset}: {lender: string, asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_b_token_rate: ({asset}: {asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_b_token_supply: ({asset}: {asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  borrow: ({borrower, asset, amount}: {borrower: string, asset: string, amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * Repay debt
   */
  repay: ({borrower, asset, d_tokens}: {borrower: string, asset: string, d_tokens: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_d_token_balance: ({borrower, asset}: {borrower: string, asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_d_token_rate: ({asset}: {asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  calculate_borrow_limit: ({borrower}: {borrower: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  add_collateral: ({borrower, rwa_token, amount}: {borrower: string, rwa_token: string, amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  remove_collateral: ({borrower, rwa_token, amount}: {borrower: string, rwa_token: string, amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_collateral: ({borrower, rwa_token}: {borrower: string, rwa_token: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_interest_rate: ({asset}: {asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  accrue_interest: ({asset}: {asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  initiate_liquidation: ({borrower, rwa_token, debt_asset, liquidation_percent}: {borrower: string, rwa_token: string, debt_asset: string, liquidation_percent: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  fill_auction: ({auction_id, liquidator}: {auction_id: string, liquidator: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * Deposit to backstop
   */
  deposit_to_backstop: ({depositor, amount}: {depositor: string, amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  withdraw_from_backstop: ({depositor, amount}: {depositor: string, amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_pool_balance: ({asset}: {asset: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_collateral_factor: ({rwa_token}: {rwa_token: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
